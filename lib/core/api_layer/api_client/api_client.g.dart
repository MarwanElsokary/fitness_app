...
class _ApiClient implements ApiClient {
  ...
  Future<OtpVerificationResponseDto> verifyOtp(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<OtpVerificationResponseDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OtpVerificationResponseDto _value;
    try {
      _value = OtpVerificationResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DailyRecommendationExerciseDto> getDailyRecommendationExercise(
    ...
    final queryParameters = <String, dynamic>{
      r'limit': limit,
      r'targetMuscleGroupId': targetMuscleGroupId,
      r'difficultyLevelId': difficultyLevelId,
    };
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DailyRecommendationExerciseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/exercises/random',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DailyRecommendationExerciseDto _value;
    try {
      _value = DailyRecommendationExerciseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetExerciseResponse> getExercisesByMuscleDifficulty(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetExerciseResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetExerciseResponse _value;
    try {
      _value = GetExerciseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  getAllDifficultyLevelsByPrimeMoverMuscle(String? primeMoverMuscleId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'primeMoverMuscleId': primeMoverMuscleId,
    };
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AllDifficultyLevelByPrimeMuscleResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllDifficultyLevelByPrimeMuscleResponse _value;
    try {
      _value = AllDifficultyLevelByPrimeMuscleResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
